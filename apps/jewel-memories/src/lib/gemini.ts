 ...
 *
 * On utilise le modèle d'édition/génération d'images de Gemini
 * (« Nano Banana », `gemini-2.5-flash-image`) : on lui envoie la photo
 * d'origine + une consigne, il renvoie une nouvelle image.
 *
...
/** Consigne de style envoyée au modèle pour obtenir un line art gravable. */
