...
/**
 * Capture de leads dans une base Notion.
 * Variables d'environnement : NOTION_TOKEN, NOTION_LEADS_DATABASE_ID.
 *
 * Schéma de base attendu : Email (titre), Source (sélection), Support (texte),
 * Matière (texte), Prix (nombre), Capturé le (date).
 */
